...
useEffect(()=>{
 ...
 <Button onClick={nav} sx={{background:"#e25252" , color:"white" , fontWeight:"700" , fontSize:"20px",borderRadius:"17px" , width:"13em"  , boxShadow:"inset 5px -3px 4px rgba(0, 0, 0, 0.25), inset -5px -3px 4px rgba(0, 0, 0, 0.25)" ,alignSelf:"center"}} className='body1'>Let's Match <img src={couple} alt="" width={50}  /> </Button>
    </Box>
